...
2. [[state_space|Define State Space]]
3. [[observation_space|Define Observation Space]]
4. [[action_space|Define Action Space]]
5. [[prior_beliefs|Establish Prior Beliefs]]

### 2. Model Structure
1. [[variable_types|Choose Variable Types]]
2. [[hierarchical_organization|Define Hierarchy]]
3. [[temporal_depth|Specify Temporal Depth]]
4. [[message_passing|Design Message Passing]]

### 3. Temporal Aspects
1. [[timescale_selection|Determine Timescales]]
2. [[prediction_horizon|Configure Prediction Horizon]]
3. [[update_schedule|Set Update Schedules]]
4. [[temporal_dependencies|Define Dependencies]]

### 4. Learning Configuration
1. [[fixed_components|Set Fixed Components]]
2. [[learnable_parameters|Define Parameters]]
3. [[adaptation_rules|Configure Adaptation]]
4. [[learning_rates|Set Learning Rates]]

### 5. Integration Strategy
1. [[component_integration|Component Integration]]
2. [[interface_design|Interface Design]]
3. [[data_flow|Data Flow]]
4. [[process_coordination|Process Coordination]]
...
2. Parr, T., & Friston, K. J. (2018). Active Inference: A Process Theory
...
6. Parr, T., et al. (2020). System Integration in Active Inference
7. Smith, R., et al. (2021). Validation Frameworks for Active Inference
8. Johnson, M., et al. (2022). Implementation Guidelines for Cognitive Architectures 
