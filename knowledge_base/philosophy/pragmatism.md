...
1. **Social Practices**: Emphasizing the normative dimensions of social practices

1. **Anti-foundationalism**: Developing more radical critiques of epistemological foundations

1. **Cultural Politics**: Connecting philosophical inquiry to cultural and political criticism

1. **Interdisciplinary Engagement**: Engaging with developments in cognitive science, linguistics, and social theory
...
1. **Peirce's View**: Truth is the opinion that would be agreed upon by an ideal community of inquirers given sufficient time and evidence

1. **Dewey's View**: Truth (or "warranted assertibility") is the outcome of successful inquiry that resolves problematic situations
...
1. **Secondary/Reflective Experience**: Conceptual, scientific, philosophical reflection on primary experience

1. **Experimental Method**: Application of [[scientific_method]] to all domains of human experience
...
1. Truth is what survives the test of experience

1. Beliefs are instruments for action, not passive representations

1. Inquiry is a communal, self-correcting process
...
1. Imaginatively projecting possible resolutions

1. Evaluating likely consequences

1. Testing proposed solutions in experience
...
1. **Deduction**: Working out the experiential consequences of hypotheses

1. **Induction**: Testing hypotheses against experience

1. **Community Verification**: Intersubjective testing and criticism
...
1. Learning by doing rather than passive absorption

1. School as a democratic community

1. Integration of subjects around problems

1. Scientific method as educational paradigm
...
1. **Scientific Pragmatism**: Emphasizes continuity with natural sciences (Quine, Sellars)

1. **Feminist Pragmatism**: Develops pragmatist insights in feminist directions (Seigfried, Sullivan)

1. **Environmental Pragmatism**: Applies pragmatic method to environmental problems (Norton, Light)

1. **Analytic Pragmatism**: Combines pragmatist insights with analytic precision (Misak, Price)

1. **Global Pragmatism**: Explores connections with non-Western philosophical traditions (Shusterman, Koopman)
...
1. **[[predictive_processing|Predictive Processing]]**: Mind as prediction machine, minimizing surprise

1. **[[active_inference|Active Inference]]**: Knowledge through action and prediction

1. **[[ecological_psychology|Ecological Psychology]]**: Perception as detection of affordances for action
...
1. **Fallibilism → Bayesian Updating**: Both embrace ongoing belief revision in light of new evidence

1. **Inquiry Process → Perception-Action Cycles**: Both characterize cognition as cyclical testing of hypotheses

1. **Experience → Embodied Prediction**: Both emphasize the bodily, situated nature of knowledge

1. **Community Verification → Cultural Learning**: Both recognize the social dimensions of knowledge generation
...
1. **[[phenomenology]]**: Through shared interests in embodiment and lived experience

1. **[[critical_theory]]**: Through concerns with social critique and progressive change

1. **[[american_philosophy]]**: As the cornerstone of a distinctive philosophical tradition
...
1. **Verificationism Problem**: Is meaning reducible to verification procedures?

1. **Scientism Concern**: Does pragmatism privilege scientific over other forms of knowledge?

1. **Radical Individualism**: Does pragmatism's emphasis on consequences support egoism?

1. **Conservatism Critique**: Does pragmatism's emphasis on existing practices reinforce status quo?

1. **Incoherence Objection**: Can pragmatism's account of truth avoid circularity?
...
1. **Against Verificationism**: Verification is holistic, not reducible to simple observational tests

1. **Against Scientism**: Scientific method is extended to all domains, but diverse methods are recognized

1. **Against Individualism**: Pragmatism emphasizes community and social consequences

1. **Against Conservatism**: Pragmatism emphasizes creative intelligence and social reconstruction

1. **Against Incoherence**: Pragmatism offers a functional, not foundational, account of truth
...
1. **Dissolve Pseudo-Problems**: Identify and bypass questions with no practical difference

1. **Maintain Fallibilism**: Hold all beliefs open to revision

1. **Embrace Experimentalism**: Test ideas through action

1. **Prioritize Concrete Problems**: Address real problems over abstract theories

1. **Consider Multiple Perspectives**: Value diverse viewpoints in inquiry

1. **Connect Theory and Practice**: Ensure theoretical work addresses practical concerns

1. **Promote Democratic Values**: Foster inclusive community inquiry

1. **Embrace Pluralism**: Recognize multiple valid approaches to problems

1. **Balance Individual and Social**: Consider both personal and communal consequences

### Common Issues

1. **Overly Subjective**: Confusing "what works for me" with pragmatic truth

1. **Short-Term Focus**: Emphasizing immediate consequences over long-term effects

1. **Neglecting Theory**: Dismissing theoretical work that lacks obvious practical application

1. **Naive Experimentalism**: Failing to recognize the theory-laden nature of experience

1. **Reductive Instrumentalism**: Reducing all values to utilitarian calculus

1. **Methodological Vagueness**: Lack of specific procedures for inquiry

1. **Conflating Descriptive/Normative**: Confusing what works with what ought to work

1. **Democratic Romanticism**: Idealizing democratic processes without addressing power dynamics
