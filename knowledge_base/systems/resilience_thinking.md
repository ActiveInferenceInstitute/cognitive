...
```mermaid
graph TD
    A[Rapid Growth<br/>Exploitation<br/>r-Strategy] --> B[Conservation<br/>Accumulation<br/>K-Strategy]
    B --> C[Release<br/>Creative Destruction<br/>Ω-Phase]
    C --> D[Reorganization<br/>Innovation<br/>α-Phase]
    D --> A
...
```mermaid
graph TD
    A[Ball in Landscape] --> B[Stable Basins]
    A --> C[Unstable Peaks]
    A --> D[Thresholds]

    B --> B1[Homeostatic Regulation]
    B --> B2[Resistance to Change]

    C --> C1[Vulnerable States]
    C --> C2[Tipping Points]
