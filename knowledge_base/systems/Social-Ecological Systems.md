...
```mermaid
graph TD
    A[Socio-Ecological System] --> B[Resource Systems]
    A --> C[Governance Systems]
    A --> D[Users]
    A --> E[Interactions]
    A --> F[Outcomes]

    B --> B1[Resource Units]
    B --> B2[Goodness of Fit]
    B --> B3[Economic Value]

    C --> C1[Governance Activities]
    C --> C2[Networks]
    C --> C3[Property Rights]

    D --> D1[Number of Users]
    D --> D2[Socioeconomic Attributes]
    D --> D3[History of Use]

    E --> E1[Harvesting Levels]
    E --> E2[Information Sharing]
    E --> E3[Deliberation Processes]

    F --> F1[Social Performance]
    F --> F2[Ecological Performance]
    F --> F3[Economic Performance]
```
...
```mermaid
graph LR
    A[Growth/Conservation] --> B[Release/Collapse]
    B --> C[Reorganization]
    C --> D[Exploitation/Renewal]
    D --> A
```
