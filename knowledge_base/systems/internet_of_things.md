...
2. **Sensing Capability**: Equipped with sensors to collect data from the environment
3. **Intelligence**: Processing capabilities from basic microcontrollers to advanced edge computing
4. **Actuation**: Ability to affect physical environments through controllers, motors, or other mechanisms
5. **Interoperability**: Communication across different platforms, protocols, and standards
6. **Autonomy**: Capable of operating with minimal human intervention
7. **Identifiability**: Uniquely addressable with identification protocols
8. **Scalability**: Architecture that accommodates growth from small to massive deployments
...
3. Al-Fuqaha, A., et al. (2015). "Internet of Things: A Survey on Enabling Technologies, Protocols, and Applications." IEEE Communications Surveys & Tutorials.
4. Borgia, E. (2014). "The Internet of Things Vision: Key Features, Applications and Open Issues." Computer Communications.
5. Gubbi, J., et al. (2013). "Internet of Things (IoT): A Vision, Architectural Elements, and Future Directions." Future Generation Computer Systems.
6. Miorandi, D., et al. (2012). "Internet of Things: Vision, Applications and Research Challenges." Ad Hoc Networks.
7. Perera, C., et al. (2014). "Context Aware Computing for the Internet of Things: A Survey." IEEE Communications Surveys & Tutorials.
8. Stankovic, J.A. (2014). "Research Directions for the Internet of Things." IEEE Internet of Things Journal.
9. Wortmann, F., & Flüchter, K. (2015). "Internet of Things: Technology and Value Added." Business & Information Systems Engineering.
10. Zhou, J., et al. (2013). "Security and Privacy for Cloud-Based IoT: Challenges." IEEE Communications Magazine.
11. Fortino, G., & Trunfio, P. (2014). "Internet of Things Based on Smart Objects: Technology, Middleware and Applications." Springer.
12. Li, S., Xu, L.D., & Zhao, S. (2015). "The Internet of Things: A Survey." Information Systems Frontiers.
13. Buyya, R., & Dastjerdi, A.V. (2016). "Internet of Things: Principles and Paradigms." Morgan Kaufmann.
14. Farooq, M.U., et al. (2015). "A Critical Analysis on the Security Concerns of Internet of Things (IoT)." International Journal of Computer Applications.
15. Rayes, A., & Salam, S. (2019). "Internet of Things From Hype to Reality: The Road to Digitization." Springer. 