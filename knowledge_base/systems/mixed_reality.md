...
1. **Spatial Understanding**: Comprehensive awareness of the physical environment's structure and contents

1. **Real-time Interaction**: Immediate and natural interaction between users, physical objects, and digital content

1. **Contextual Awareness**: Adaptation to environmental conditions, user needs, and situational factors

1. **Persistence**: Digital content that maintains its position and state in physical space over time

1. **Multi-user Capability**: Shared experiences where multiple participants interact with the same mixed reality elements

1. **Cross-modal Experience**: Integration of visual, auditory, haptic, and other sensory information
...
1. Speicher, M., Hall, B. D., & Nebeling, M. (2019). "What is Mixed Reality?" CHI Conference on Human Factors in Computing Systems.
...
1. Mann, S. (2002). "Mediated Reality with Implementations for Everyday Life." Presence: Teleoperators and Virtual Environments.
...
1. Benford, S., & Giannachi, G. (2011). "Performing Mixed Reality." MIT Press.
...
1. Jerald, J. (2015). "The VR Book: Human-Centered Design for Virtual Reality." Morgan & Claypool.

1. Shneiderman, B., et al. (2016). "Designing the User Interface: Strategies for Effective Human-Computer Interaction." Pearson.

1. Cheok, A. D., Levy, D., & Karunanayaka, K. (2016). "Multimodal Perception and Mixed Reality." Springer.
