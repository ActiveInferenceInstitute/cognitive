...
1. Connection of [[generalized_coordinates]] to predictions

1. Formalization of relationships between different orders of motion

1. Implementation of [[hierarchical_inference]] across temporal scales
...
1. Monitor error growth ([[error_analysis]])

1. Adapt step sizes ([[adaptive_step_size]])

1. Validate predictions ([[validation_methods]])

### 2. Optimization

1. Efficient computation ([[computational_efficiency]])

1. Memory management ([[memory_optimization]])

1. Parallel processing ([[parallel_computation]])

1. GPU acceleration ([[gpu_optimization]])

## References

1. [[friston_2008]] - "Hierarchical models in the brain"

1. [[buckley_2017]] - "The free energy principle for action and perception: A mathematical review"

1. [[baltieri_2019]] - "PID control as a process of active inference"

1. [[parr_2019]] - "Generalised free energy and active inference"

1. [[da_costa_2020]] - "Active inference on discrete state-spaces"

1. [[millidge_2021]] - "Neural active inference: Deep learning of prediction, action, and precision"
