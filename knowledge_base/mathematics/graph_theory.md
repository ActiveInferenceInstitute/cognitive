...
1. The multiplicity of eigenvalue 0 equals the number of connected components

1. The second smallest eigenvalue $\lambda_2$ (algebraic connectivity) characterizes connectivity
