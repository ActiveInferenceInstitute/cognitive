...
- **Bayesian Updates**: Belief revision and posterior computation
- **Variational Methods**: Variational inference for belief updating
...
### Policy Selection (`policy_selection/`)
- **Expected Free Energy**: Policy evaluation via EFE minimization
- **Action Selection**: Action sampling and selection strategies

### State Estimation (`state_estimation/`)
- **Filtering**: State estimation and filtering methods
- **Smoothing**: Retrospective state estimation
...
- [[code/tools/src/README|Source Code Overview]]
...
### Core Components
- [[active_inference/README|Active Inference Models]]
