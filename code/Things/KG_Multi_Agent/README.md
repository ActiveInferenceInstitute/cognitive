...
### Key Components
- infer queries batch - Main processing engine
- process conversations - Conversation preprocessor
- MKG utils - Utility functions
- graphRAG naive.ipynb - Jupyter notebook examples

## 🔗 Related Documentation

### Theoretical Foundations
- [[knowledge_base/cognitive/social_cognition|Social Cognition]]
- [[knowledge_base/systems/network_theory|Knowledge Graphs & Network Theory]]
- [[knowledge_base/cognitive/swarm_intelligence|Swarm Intelligence]]

### Related Implementations
- [[code/Things/Ant_Colony/README|Ant Colony]] - Swarm intelligence foundations
- [[code/Things/BioFirm/README|BioFirm]] - Ecological multi-agent systems
- [[tools/src/models/README|Agent Models]] - Individual agent implementations

### Research Resources
- [[docs/repo_docs/research|Research Documentation]]
...
- Example Outputs - Generated knowledge and visualizations
