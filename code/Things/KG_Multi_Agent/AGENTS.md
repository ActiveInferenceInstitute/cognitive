...
### Key Components
- infer queries batch - Main knowledge extraction engine
- process conversations - Conversation preprocessing
- MKG utils - Utility functions and coordination
...
- [[code/Things/Ant_Colony/README|Ant Colony]] - Swarm coordination patterns
- [[code/Things/BioFirm/README|BioFirm]] - Multi-scale coordination
