...
See Baseball Game Implementation Details for:
...
### Key Components
- Baseball Game - Core game framework documentation
...
- [[knowledge_base/cognitive/decision_making|Game Theory & Decision Making]]
- [[knowledge_base/cognitive/decision_making|Strategic Reasoning]]

### Related Implementations
- [[code/Things/Generic_POMDP/README|Generic POMDP]] - Decision making under uncertainty
- [[code/Things/KG_Multi_Agent/README|KG Multi-Agent]] - Multi-agent coordination
