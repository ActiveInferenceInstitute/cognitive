...
- **Financial and research system support**:
  ...
  - Secured philanthropic contributions and pursued grants (including initiatives focused on [[knowledge_base/free_energy_principle/applications/ai_safety]]).
...
- **AI Safety and Ethics**: Establish a dedicated research group to explore the implications of [[active_inference]] for [[knowledge_base/free_energy_principle/applications/ai_safety]], focusing on alignment, interpretability, and ethical considerations in autonomous systems.
...
- **Real-World Deployments**: Facilitate the deployment of [[active_inference]]-based solutions in real-world settings, demonstrating tangible benefits in health, sustainability, [[knowledge_base/free_energy_principle/applications/ai_safety]], and other critical domains.
...
## Mission and Activities (External Summary)

- **Mission**: Advance the understanding and application of Active Inference (rooted in the Free Energy Principle) as a unified approach to modeling intelligent systems that minimize uncertainty through perception and action.

- **Core activities**:

  - **Livestreams and Workshops**: Regular programming across machine learning, computational modeling, psychology, philosophy, biology, sociology, quantum mechanics, and robotics.

  - **Textbook & Study Groups**: Ongoing cohorts studying foundational texts (e.g., Parr, Pezzulo, Friston, "Active Inference: The Free Energy Principle in Mind, Brain, and Behavior").

  - **Internships & Fellowships**: Opportunities for self-directed, mentored research aligned with Institute focus areas.

## Community Engagement

- **Open science**: Global participation across time zones with accessible, participatory research and education.

- **Volunteering**: Contributions to study groups, livestream production, publications, symposiums, applied research, and communications.

- **Scientific Advisory Board**: Interdisciplinary experts providing scientific and strategic guidance.

## Collaborations and Events

- **Nature Based AI Joint Initiative (2023)**: Collaboration with the Boston Global Forum to integrate natural systems and neuroscience into AI development for societal benefit.

- **Applied Active Inference Symposium (annual)**: The 4th Symposium (Nov 2024) featured work on decentralized AI and the Spatial Web Protocol, among other topics.

## Getting Involved

- **Community channels**: Discord for discussions and meetings; newsletter for event and program updates.

- **Support**: Donations welcomed to sustain education and research initiatives.

- **Contact**: [blanket@activeinference.institute](mailto:blanket@activeinference.institute)

- **Learn more**: Visit the Active Inference Institute website for livestreams, programs, and participation pathways.

References:

- Free Energy Principle overview: [Wikipedia](https://en.wikipedia.org/wiki/Free_energy_principle)

- AII livestreams and programs: [Active Inference Institute](https://www.activeinference.institute/)

- Nature Based AI Joint Initiative (Boston Global Forum + AII): [Announcement](https://dukakis.org/shaping-futures/nature-based-ai-joint-initiative-science-technology-policy-boston-global-forum-active-inference-institute/)
