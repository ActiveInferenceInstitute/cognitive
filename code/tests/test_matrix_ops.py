...
import numpy as np
import pytest
from cognitive.models.matrices.matrix_ops import MatrixInitializer, MatrixLoader, MatrixOps
...
@pytest.mark.parametrize("shape,strength", [((2, 2), 0.9), ((3, 3), 0.8), ((4, 4), 0.7)])
