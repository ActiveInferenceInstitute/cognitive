...
def agent():
    ...
    return ContinuousActiveInference(n_states=2, n_obs=2, n_orders=3, dt=0.001, alpha=0.1)
...
class TestGeneralizedCoordinates:
    ...
    def test_coordinate_relationships(self, agent, visualizer, test_output_dir):
        ...
        # Create animation
        visualizer.save_animation(history, test_output_dir / "belief_animation.gif", fps=30)
...
class TestSummaryVisualization:
    ...
    def test_summary_plots(self, agent, visualizer, test_output_dir):
        ...
        visualizer.create_summary_plot(history, test_output_dir / "summary.png")
