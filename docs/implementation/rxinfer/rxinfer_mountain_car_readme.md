...
1. **Exploration vs Exploitation**: Balancing between exploring new strategies and exploiting known ones

1. **State Uncertainty**: Dealing with noisy observations and imperfect dynamics

1. **Long-term Planning**: Developing strategies that consider future consequences
...
1. **[[precision_weighting|Precision Weighting]]**:
...
1. [[reactive_mp|ReactiveMP.jl Documentation]]

1. [[graph_ppl|GraphPPL.jl Documentation]]

1. [[mountain_car_env|Mountain Car Environment Documentation]]

1. [[da2020active|Da Costa, et al. (2020). Active inference on discrete state-spaces]]

1. [[buckley2017free|Buckley, et al. (2017). The free energy principle for action and perception]]

1. [[catal2020deep|Çatal, et al. (2020). Deep active inference]]

1. [[tschantz2020scaling|Tschantz, et al. (2020). Scaling active inference]]
