...
1. **Fill in all required sections** with relevant information

1. **Use consistent linking** to connect related documents

1. **Include Mermaid diagrams** to visualize relationships and processes

1. **Maintain metadata** including creation date, status, and tags
