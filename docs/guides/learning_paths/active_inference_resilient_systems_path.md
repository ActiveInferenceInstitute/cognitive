...
2. Beyer, B., Jones, C., Petoff, J., & Murphy, N. R. (2016). *Site Reliability Engineering: How Google Runs Production Systems*.
3. Rosenthal, C., et al. (2020). *Chaos Engineering: System Resiliency in Practice*.
4. Fowler, M. & Lewis, J. (2014). *Microservices: A Definition of This New Architectural Term*.

### Online Resources

1. [[knowledge_base/systems/resilient_systems|Resilient Systems Knowledge Base]]
2. [[knowledge_base/systems/fault_tolerance|Fault Tolerance Knowledge Base]]
3. Netflix Tech Blog - Resilience Engineering articles
4. AWS Well-Architected Framework - Reliability Pillar
5. Microsoft Azure Architecture Center - Resiliency patterns

### Communities and Forums

1. Chaos Community Days
2. SREcon Conference Resources
3. Resilience Engineering Association
4. Cloud Native Computing Foundation (CNCF) communities
