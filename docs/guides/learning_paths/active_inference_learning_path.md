...
2. Implement sophisticated Active Inference agents for complex tasks
3. Apply Active Inference to real-world problems in robotics, neuroscience, and AI
4. Contribute to cutting-edge research in the field
