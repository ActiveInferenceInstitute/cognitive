...
- Re-derive core info-theoretic identities used in VFE/EFE; connect to modeling choices

- Design a small literature mini-review plan (systematic) and extraction template

- Set up a reproducibility checklist for any analysis code you create
...
1. Conduct systematic literature reviews and meta-analyses

1. Design and execute rigorous research studies

1. Prepare high-quality academic publications and presentations
